...
By applying liveness and interactivity, programming environments such as Smalltalk enable programmers to iteratively explore problems.
As we have seen through the analogy of aiming at a target using a water hose, this is enabled by tight feedback loops, which in turn provide continuous feedback and eliminate that one has to stop to re-aim.
...
Based on this analysis, we hypothesize that accepting and embracing incomplete programs while applying ideas rooted in live programming enables software development teams to improve their shared understanding (theory) and aids individual developers in coping with high cognitive load, imposed by complex programming problems.
...
By accepting the existence of evolutionary prototypes, instead of trying eliminate them, we plan on introducing primitives that improve their development while emphasizing quality by explicitly highlighting prototypical parts.
% the need for solid software architecture

\subsubsection{Research Question}
Building upon this hypothesis, this thesis' research question is defined as: \emph{Analyzing hole-driven development and existing soltions regarding the handling of todo-comments, which of these aspects can be transferred to widely used general purpose programming languages?}
...
Furthermore, recent language features like Analyzers\footnote{\url{}} and Source Generators\footnote{\url{}} enable the development of plug-ins independent of the integrated development environment (IDE) used.
