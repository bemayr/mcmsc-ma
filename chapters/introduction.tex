...
Targeting the previously described problem of shortening the feedback loop, several frameworks and programming tools are actively trying to shorten it in various ways \cite{kubelka_road_2018}:
\begin{itemize}
...
\begin{longtable}{@{}cp{0.37\textwidth}p{0.48\textwidth}@{}}
    % -------------------------- first header ----------------------------
    \caption{Applying the lens of tightening feedback loops through live programming to the agile principles \cite{beck_manifesto_2001}.} 
    \label{tab:agile-principles}																						 \\
    \toprule
...
In his essay \citetitle{gladden_stop_1982} \cite{gladden_stop_1982} about the shortcomings of the waterfall model, \citeauthor{gladden_stop_1982} argues that sequential software development processes lead to missed schedules and the creation of unsuccessful products in a sense that the produced software \begin{enumerate*}[label=(\roman*)]
...
The word's origin goes back to Ancient Greek \emph{\textgreek{πρωτότυπος}} (original; prototypos), with the conjunction of \emph{\textgreek{πρῶτος}}, (first; earliest) and \emph{\textgreek{τῠπος}} (pressing; sort; type; sign). % ῠ́π
...
\subsection{Programming Seen as Complex Problem Solving}
...
Applying the conversational lens to the greater context of developing software in teams and organizations leads to Peter Naur's influential paper \citetitle{naur_programming_1985} \cite{naur_programming_1985}.
...
This might also be based on the fact that in contrast to the formal parts of the source code, comments (hence todo comments as well) represent the informal part of source code \cite{ying_source_2005, nie_framework_2019, sridhara_automatically_2016, storey_todo_2008}.
...
\subsubsection{Creative Usage of/Alternatives to Todo Comments}
...
% the need for solid software architecture
